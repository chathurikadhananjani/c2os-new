...
os_draw_background3:
	...
	mov cx, 01101100b		; Colour: red text on Black background
...
.noleft:
	...
	mov bl, 11110110b		; White on red for cancel button
	mov dh, 14
	mov dl, 43
	mov si, 8
	mov di, 15
...
.noright:
	...
	.cancel_button_string	db 'ShutDown', 0
	.ok_button_noselect	db '   Menu   ', 0
	.cancel_button_noselect	db '   ShutDown   ', 0
...
.one_button:
	mov bl, 11110110b		; Black on white
	mov dh, 14
	mov dl, 35
	mov si, 8
	mov di, 15
...
.two_button:
	mov bl, 10110010b		; Black on white
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15
...
.two_button_wait:
	...
	mov bl, 01011011b		; White on red for cancel button
	mov dh, 14
	mov dl, 42
	mov si, 9
	mov di, 15
...
.noleft:
	...
	mov bl, 01101101b		; Black on white
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15
