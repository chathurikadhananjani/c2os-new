...
os_main:
	...
	mov es, ax			; segments ever again, as C2OS and its programs
...
option_screen:
	...
	mov cx, 10101111b		; Colour: white text on light blue
	...
	call os_exit		; C2OS will be shutting down
	


	; Data for the above code...

	os_init_msg		db 'Welcome to C2 OS', 0
	os_version_msg		db 'Version ', C2OS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', C2OS_VER, 0

	dialog_string_1		db '        You are Using C2OS !  ', 0
	dialog_string_2		db '   *  MENU     -->   main menu', 0
	dialog_string_3		db '   *  SHUTDOWN -->   turn off C2OS', 0
...
option_screen2:
	...
	mov cx, 011001011011010		; Colour: white text on light blue
	call os_draw_background
	...
	os_init_msg3		db 'Welcome to C2OS', 0
	os_version_msg3		db 'Version ', C2OS_VER, 0

	dialog_string_7		db '           C2OS !              ', 0
	dialog_string_8		db '    INFO --> HARDWARE INFORMATION    ', 0
	dialog_string_9		db '    BACK --> HOME                    ', 0
